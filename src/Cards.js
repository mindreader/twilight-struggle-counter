...
class Cards {
  static cards = () =>
    Map({
      ...
      come:  Map({name: "comecon",         early:  true, event: true,  side: "ussr",    ops: 3}),
      ...
      deg:  Map({name: "degaulle leads france",         early:  true, event: true,  side: "ussr",    ops: 3}),
      cns:  Map({name: "captured nazi scientist",         early:  true, event: true,  side: "neutral",    ops: 2}),
      trum:  Map({name: "truman doctrine",         early:  true, event: true,  side: "us",    ops: 1}),
      ...
      suez:  Map({name: "suez crisis",         early:  true, event: true,  side: "ussr",    ops: 3}),
      ...
      ntb:  Map({name: "nuclear test ban",         early:  true, event: false,  side: "neutral",    ops: 4}),
      form:  Map({name: "formosan resolution",         early:  true, event: true,  side: "us",    ops: 2}),
      def:  Map({name: "defectors",         early:  true, event: false,  side: "us",    ops: 2}),
      ...
      subs:  Map({name: "nuclear subs",         mid:  true, event: true,  side: "us",    ops: 2}),
      qm:  Map({name: "quagmire",         mid:  true, event: true,  side: "ussr",    ops: 3}),
      salt:  Map({name: "salt negotiations",         mid:  true, event: true,  side: "neutral",    ops: 3}),
      bt:  Map({name: "bear trap",         mid:  true, event: true,  side: "us",    ops: 3}),
      sum:  Map({name: "summit",         mid:  true, event: false,  side: "neutral",    ops: 1}),
      ...
      mis:  Map({name: "missile envy",         mid:  true, event: false,  side: "neutral",    ops: 2}),
      wwby:  Map({name: "we will bury you",         mid:  true, event: true,  side: "ussr",    ops: 4}),
      brez:  Map({name: "brezhnev doctrine",         mid:  true, event: true,  side: "ussr",    ops: 3}),
      ...
      cult:  Map({name: "cultural revolution",         mid:  true, event: true,  side: "ussr",    ops: 3}),
      fp:  Map({name: "flower power",         mid:  true, event: true,  side: "ussr",    ops: 4}),
      u2:  Map({name: "U-2 incident",         mid:  true, event: true,  side: "ussr",    ops: 3}),
      opec:  Map({name: "opec",         mid:  true, event: false,  side: "ussr",    ops: 3}),
      ...
      lads:  Map({name: "latin american death squads",         mid:  true, event: false,  side: "neutral",    ops: 2}),
      ...
      shu:  Map({name: "shuttle diplomacy",         mid:  true, event: true,  side: "us",    ops: 3}),
      ...
      ask:  Map({name: "ask not what your country...",         mid:  true, event: true,  side: "us",    ops: 3}),
      pro:  Map({name: "alliance for progress",         mid:  true, event: true,  side: "us",    ops: 3}),
      ...
      host:  Map({name: "iranian hostage crisis",         late:  true, event: true,  side: "ussr", ops: 3}),
      il:  Map({name: "the iron lady",         late:  true, event: true,  side: "us", ops: 3}),
      rbl:  Map({name: "reagan bombs libya",         late:  true, event: true,  side: "us", ops: 2}),
      sw:  Map({name: "star wars",         late:  true, event: true,  side: "us", ops: 2}),
      nso:  Map({name: "north sea oil",         late:  true, event: true,  side: "us", ops: 3}),
      ref:  Map({name: "the reformer",         late:  true, event: true,  side: "ussr", ops: 3}),
      mbb:  Map({name: "marine barracks bombing",         late:  true, event: true,  side: "ussr", ops: 2}),
      kal:  Map({name: "soviets shoot down KAL-007",         late:  true, event: true,  side: "us", ops: 4}),
      glas:  Map({name: "glasnost",         late:  true, event: true,  side: "ussr", ops: 4}),
      ort:  Map({name: "ortega elected in nicaragua",         late:  true, event: true,  side: "ussr", ops: 2}),
      ter:  Map({name: "terrorism",         late:  true, event: false,  side: "neutral", ops: 2}),
      ics:  Map({name: "iron-contra scandal",         late:  true, event: true,  side: "ussr", ops: 2}),
      cnb:  Map({name: "chernobyl",         late:  true, event: true,  side: "us", ops: 3}),
      ladc:  Map({name: "latin american debt crisis",         late:  true, event: false,  side: "ussr", ops: 2}),
      tdw:  Map({name: "tear down this wall",         late:  true, event: true,  side: "us", ops: 3}),
      evl:  Map({name: "an evil empire",         late:  true, event: true,  side: "us", ops: 3}),
      ald:  Map({name: "aldrich ames remix",         late:  true, event: true,  side: "ussr", ops: 3}),
      per:  Map({name: "pershing II deployed",         late:  true, event: true,  side: "ussr", ops: 3}),
      wg:  Map({name: "wargames",         late:  true, event: true,  side: "neutral", ops: 4}),
      sol:  Map({name: "solidarity",         late:  true, event: true,  side: "us", ops: 2}),
      iiw:  Map({name: "iran iraq war",         late:  true, event: true,  side: "neutral", ops: 2}),
      cam:  Map({name: "the cambridge five",         late:  true, event: false,  side: "ussr", ops: 2}),
      sr:  Map({name: "special relationship",         late:  true, event: false,  side: "us", ops: 2}),
      nrd:  Map({name: "norad",         late:  true, event: true,  side: "us", ops: 3}),
      che:  Map({name: "che",         late:  true, event: true,  side: "ussr", ops: 3}),
      omt:  Map({name: "our man in tehran",         late:  true, event: true,  side: "us", ops: 2}),
      awac:  Map({name: "awacs sale to saudis",         late:  true, event: true,  side: "us", ops: 3}),
    })
